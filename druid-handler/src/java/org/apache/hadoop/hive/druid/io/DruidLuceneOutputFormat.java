...
public class DruidLuceneOutputFormat <K, V> implements HiveOutputFormat<K, DruidWritable> {
  ...
  public FileSinkOperator.RecordWriter getHiveRecordWriter(
    ...
    String indexType = jc.get("hive.druid.index.type", "druid");

    return new DruidLuceneRecordWriter(dataSchema, realtimeTuningConfig, hdfsDataSegmentPusher,
